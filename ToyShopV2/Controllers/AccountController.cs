...
namespace ToyShopV2.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Login(string returnUrl = "/toys") => View(new LoginViewModel { ReturnUrl = returnUrl });
        ...
        public async Task<RedirectResult> Logout(string returnUrl = "/toys")
        {
